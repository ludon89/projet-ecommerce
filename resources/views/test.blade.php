  ...
  <div x-data="{ cartOpen: false, isOpen: false }" class="bg-dark">
      ...
      <div class="container mx-auto px-6 py-3">
        ...
        <div class="relative mt-6 max-w-lg mx-auto">
          <span class="absolute inset-y-0 left-0 pl-3 flex items-center">
            <svg class="h-5 w-5 text-gray-500" viewBox="0 0 24 24"
              fill="none">
              <path
    ...
    <div
      ...
      <div class="mt-8">
        <form class="flex items-center justify-center">
          <input class="form-input w-48" type="text"
    ...
    <footer class="bg-gray-200">
      <div
        ...
        <a href="#"
          class="text-xl font-bold text-gray-500 hover:text-gray-400">Brand</a>
