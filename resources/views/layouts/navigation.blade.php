        ...
        <div class="flex items-center justify-end w-full">
            @auth
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <a class="text-yellow focus:outline-none mx-4 sm:mx-0" href={{ route('logout') }}
            ...
            <button class="text-yellow focus:outline-none mx-4 sm:mx-0">
                ...
                <svg class="h-9 w-9" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="flex sm:hidden">
                <button @click="isOpen = !isOpen" type="button"
                        class="text-yellow focus:outline-none focus:text-yellow" aria-label="toggle menu">
